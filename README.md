...
| Primary <br /> Secondary | _s_ `1` <br /> _s_ `2` | Holds if _s_ is longer than higher-ranking suits and at least as long as lower-ranking suits. <br /> Holds if _s_ is up to the length of the primary suit, but longer than the remaining two suits. | `H1` <br/> `C2` |
