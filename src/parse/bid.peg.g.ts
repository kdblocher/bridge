...
* INPUT GRAMMAR:
* Start := spec=BidSpec $
* BidSpec := level=Digit bid=BidSpecifier ': ' constraints=ConstraintList
        ...
        return this.run<BidSpec>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.BidSpec, level: $scope$level, bid: $scope$bid, constraints: $scope$constraints};
                }
                return $$res;
            });
    }
        ...
        return this.run<Bid>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.Bid, level: $scope$level, strain: $scope$strain};
                }
                return $$res;
            });
    }
